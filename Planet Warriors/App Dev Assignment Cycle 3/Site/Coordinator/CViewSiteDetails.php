<?php
  ...
  {
    Header("Location: CViewSiteList.php");
  }
...
<html lang="en">
    ...
    //include the link to edit and delete (this is can't be accessed by coordinators, only surveyors)
    //echo("<a href='editCustomer.php?id=$customerID'>Edit Customer Details</a>");
    //echo("<br />");
    //echo("<a href='challengeDeleteCustomer.php?id=$customerID'>Delete Customer Details</a>");
    ?>
  </main>

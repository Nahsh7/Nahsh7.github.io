      ...
      <main>
       <div class="container-fluid px-4">
        ...
        <div class="row">
		  ...
		  <div class="column" style="background: #FFFFFF;">
		   <div class="card-header">Add Site
			   </div>
			   <div class="card-body"><a href="addSite.php" class="btn btn-primary">Add Site</a>
			   </div>
		</div>
		
		<div class="column" style="background: #FFFFFF;">
		   <div class="card-header">Edit Site
			   </div>
			   <div class="card-body"><a href="editSite.php" class="btn btn-primary">Edit Site</a>
			   </div>
		</div>

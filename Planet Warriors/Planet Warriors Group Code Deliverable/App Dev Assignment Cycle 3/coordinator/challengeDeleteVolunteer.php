...
<html lang="en">
	...
	<ol class="breadcrumb animate-box">
			...
			<li class="breadcrumb-item underline"><a href="challengeDeleteVolunteer.php">Delete Volunteer</a></li>
			</ol>
		<h1> Are you sure that you want to delete this volunteer?</h1>
	...
	?>
		...
		<a href="deleteVolunteerDetails.php?id=<?php echo($volunteerID);
		?>">
			<button class="btn btn-primary" name="yesDelete" value="Yes" type="button">Yes</button>
		</a>
		<a href=" SviewVolunteerDetails.php?id=<?php echo($volunteerID); ?>">

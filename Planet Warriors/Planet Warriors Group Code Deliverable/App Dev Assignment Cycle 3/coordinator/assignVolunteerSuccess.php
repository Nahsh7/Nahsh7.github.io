...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main>
			...
			<li class="breadcrumb-item underline"><a href="volunteerList.php">View Volunteer List</a></li>
			<li class="breadcrumb-item underline"><a href="SviewVolunteerDetails.php">View Volunteer Details</a></li>
  ...
  <ol class="breadcrumb animate-box">
				...
				<h1>Volunteer has succesfully been assigned</h1>
          <a class = "btn btn-primary" href="volunteerList.php?volunteeredSitesID=<?php echo($volunteeredSitesID);?>">View Volunteer List </a>

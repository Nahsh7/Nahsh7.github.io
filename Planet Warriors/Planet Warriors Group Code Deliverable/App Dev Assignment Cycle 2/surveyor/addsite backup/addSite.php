...
<body>
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="surveyorHome.php">Planet Warriors </br> : Add Site Form </a>
			 ...
			 <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						<h1> Add Site Form </h1>
							<div class="item form-group">
								...
								<input type="text" id="siteName" required= "required" class= "form-control " name= "siteName"> 
								</div>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" id="siteGeography" name="siteGeography" required="required" class="form-control">
								</div>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" id="siteAddress" name="siteAddress" required="required" class="form-control">
								</div>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" id="generalDescription" name="generalDescription" required="required" class="form-control">
								</div>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" id="accessFee" name="accessFee" required="required" class="form-control">
								</div>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" id="warden" name="warden" required="required" class="form-control">
								</div>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" id="wardenNo" name="wardenNo" required="required" class="form-control">
								</div>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" id="imageName" name="imageName" required="required" class="form-control">
								</div>
							...
							<div class="item form-group">
								<div class="col-md-6 col-sm-6 offset-md-2">
									<button class="btn btn-primary" name="addSiteSubmit" value="Add Site" type="submit">Add Site</button>
									<a href="addSite.php">
									<button type="reset" name="addSiteReset" value="Reset" class="btn btn-success">Reset</button>
									</a>
								</div>
							</div>

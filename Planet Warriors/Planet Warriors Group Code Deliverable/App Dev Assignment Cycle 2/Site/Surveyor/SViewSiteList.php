      ...
      <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
          <div class="nav">
            ...
            <a class="nav-link active" href="SViewSiteList.php">
      ...
      <main>
       <div class="container-fluid px-4">
		...
		if($stmt = mysqli_prepare($mysqli, "SELECT siteID, siteName, imageName FROM Site ORDER BY siteName, siteID ASC"))
		{
			...
			{
				echo("<img src='SsiteImages/".$in."' title='".$sn."'style='height: 250px; width: 250px;'/><br/>");
				echo("<label>Site ID:</label> ".$sID."<br/>");
				echo("<label>Name:</label> ".$sn."<br>");
				echo("<a href='SViewSiteDetails.php?id=".$sID."'>View Site Details</a>");
				echo("<br><br>");
			}
		}

...
INSERT INTO Site(siteName, siteGeography, address, generalDescription, accessFee, warden, wardenNo, status, imageName, surveyorID) VALUES ("Asa Wright Nature Centre", "Rain Forest", "Blanchisseuse", "This small resort, buried among mountains deep in the Trinidad rain forest, is famous for its amazing diversity in animal and plant species.", "$100", "Bruce Wayne", "736-3521", "not ready", "asawright.jpg", "1");
...
INSERT INTO Site(siteName, siteGeography, address, generalDescription, accessFee, warden, wardenNo, status, imageName, surveyorID) VALUES ("Maracus Beach", "Beach", "North of Port-of-Spain", "Maracas Bay is a bay with sandy beach on the island of Trinidad. It is located on the north side of the island, an hour's mountainous drive from the capital city of Port of Spain via the North Coast Road.", "$100", "Bruce Banner", "624-4212", "not ready", "maracus2.jpg", "1");

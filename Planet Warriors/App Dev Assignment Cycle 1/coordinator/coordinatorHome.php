    ...
    <body>
                    ...
                    <div class="sb-sidenav-menu">
                      <div class="nav">
                        ...
                        <a class="nav-link" href="CoordinatorAddVolunteer.html">
                          ...
                          <a class="nav-link" href="CoordinatorViewVolunteerLocation.html">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            View Volunteer
                          </a>

                          <a class="nav-link" href="surveyorAddVolunteer.html">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Add Volunteer
                          </a>

                          <a class="nav-link" href="CoordinatorEditVolunteer.html">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Edit Volunteer
                          </a>                         
                          <a class="nav-link" href="CoordinatorRemoveVolunteer.html">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Remove Volunteer
                          </a>
                        </div>
        ...
        <div class="row">
		  <div class="column" style="background: #FFFFFF;">
			   <div class="card-header">View Volunteer
			   </div>
			   <div class="card-body"><a href="coordinatorViewVolunteer.html" class="btn btn-primary">View Volunteer</a>
			   </div>
		  </div>
		  ...
		  <div class="column" style="background: #FFFFFF;">
		   <div class="card-header">Add Volunteer
			   ...
			   <div class="card-body"><a href="coordinatorViewVolunteer.html" class="btn btn-primary">Add Volunteer</a>
			   </div>
		</div>
		...
		<div class="column" style="background: #FFFFFF;">
		   <div class="card-header">Edit Volunteer
			   ...
			   <div class="card-body"><a href="coordinatorViewVolunteer.html" class="btn btn-primary">Edit Volunteer</a>
			   </div>
		</div>
		
		<div class="column" style="background: #FFFFFF;">
		   <div class="card-header">Remove Volunteer
			   </div>
			   <div class="card-body"><a href="coordinatorViewVolunteer.html" class="btn btn-primary">Remove Volunteer</a>
			   </div>
		</div>
		</div>
                </main>

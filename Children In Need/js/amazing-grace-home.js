...
$(document).ready(function () {
	$.getJSON("https://api.openweathermap.org/data/2.5/weather?id=993800&units=metric&appid=f930c97931bb04fca38dfec9bce3ae3d", function(data) {
...
//Current Time Function
	...
	"async": true,
	"crossDomain": true,
	"url": "https://world-time2.p.rapidapi.com/timezone/Africa/Johannesburg",
	"method": "GET",
	"headers": {
...
var settings = {
    "url": "https://api.imgur.com/3/album/ADltNou/images",
    "method": "GET",
    "timeout": 0,
    "headers": {

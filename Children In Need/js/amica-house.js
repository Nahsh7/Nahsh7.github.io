...
$(document).ready(function () {
	$.getJSON("https://api.openweathermap.org/data/2.5/weather?id=3573890&units=metric&appid=f930c97931bb04fca38dfec9bce3ae3d", function(data) {
...
var settings = {
    "url": "https://api.imgur.com/3/album/aBQgj5A/images",
    "method": "GET",
    "timeout": 0,
    "headers": {
